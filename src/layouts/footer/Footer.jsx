                ...
                <Row>
                  ...
                  <Col lg={2} sm={6}>
                    <div className="footerFollow">
                      ...
                      <div className="FooterLink">
                        ...
                        <a
                          href="https://www.linkedin.com/company/codexive-solutions/mycompany/"
                          target="_blank"
                        >
                          Linkedin
                        </a>
                  ...
                  <Col lg={3} sm={6}>
                    <div className="footernewSletter">
                      ...
                      <p>
                        {" "}
                        Send us email for Job, Projects, Guidelines ,CRM and
                        Website Quotation.{" "}
                      </p>
                      <div className="position-relative">
                        {/* <input type="email" placeholder="Enter Email" /> */}
                        <a href="mailto:info@karmadhisolutions.com">Email Us</a>
