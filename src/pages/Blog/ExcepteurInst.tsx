...
const ExcepteurInst = () => {
    ...
    const collapseDetails = [
        {
            id: "headingOne",
            title: 'Qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit',
        ...
        {
            id: "headingTwo",
            title: 'Consectetur, adipisci velit, sed quia non numquam eius modi tempora',
            details: 'Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.3 wolf moon officia aute, non cupidatat skateboard dolor brunch.Food truck quinoa nesciunt laborum eiusmod.Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single- origin coffee nulla assumenda shoreditch et.Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.Ad vegan excepteur butcher vice lomo.Leggings occaecat craft beer farm - to - table,raw denim aesthetic synth nesciunt you probably haven  heard of them accusamus labore sustainable VHS.'
        },
        {
            id: "headingThree",
            ...
            <div className='excepteurinstmainctn'>
                <div className='container'>
                    <div className='d-flex align-items-center mainLinkBox'>
                        ...
                        <div className='linkBox'>
                            <Link to='/excepteurinst' className='active'> Excepteur sint occaecat </Link>
                        </div>
                    </div>
                        ...
                        <div className='excepteurinstContent d-flex  justify-content-between'>
                            <div className='xsContainer'>
                                ...
                                <div className='collExcepteurbox'>
                                    <div id="accordion">
                                        {collapseDetails.map((data: any) => {
                                            return (
                                                <div className="card">
                                                    <div className="card-header d-flex align-items-center justify-content-between" id={data.id}>
                                                        <h5 className={collapseActive === data.id ? "mb-0 active" : "mb-0 "}>{data.title}</h5>
                                                        <button
                                                        ...
                                                        >
                                                            {collapseActive === data.id ? <img src='./img/icone/minus.png' /> : <img src='./img/icone/plus.png' />}
                                                        </button>
                                                    </div>

                                                    <div
                                                        id={data.id}
                                                        className={collapseActive === data.id ? "collapse show" : "collapse"}
                                ...
                                <div className='excepteurimgbox'>
                                    <img src='./img/images/excepteurimg.png' style={{ width: '100%', height: '300px', borderRadius: '12px', objectFit: 'cover' }} />
