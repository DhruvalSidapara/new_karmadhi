          ...
          <Row>
            ...
            <Col xl={3} sm={6}>
              <div className="specialitiescard">
                ...
                <p>
                  Whether it concerns a mobile (android/ios) app, custom
                  software, or a cloud solution, we are happy to put your
            ...
            <Col xl={3} sm={6}>
              <div className="specialitiescard">
                ...
                <p>
                  A website with a content management system where you can
                  easily manage the content of your site with packages such as
            ...
            <Col xl={3} sm={6}>
              <div className="specialitiescard">
                ...
                <p>
                  Web stores where you can sell your products, we mainly use
                  Magento and Shopify to boost your sales
                </p>
              </div>
            </Col>
          </Row>
