...
const OurProject = () => {
  ...
  return (
    <>
      <Benner title="Our Projects" info="Collection we are proud of" />
        ...
        <div className="OurProjectMain">
          <div className="container">
            <div className="d-flex align-items-center mainLinkBox">
              ...
              <div className="linkBox">
                <Link to="/ourproject" className="active">
                  {" "}
                  Projects{" "}
                </Link>
              </div>
              ...
              <div className="MainTitle">
                ...
                <div className="MainDetailsBox">
                  <p>
                    ...
                    technologies and we apply our full range of talent to
                    creating the perfect solution for each client’s needs.
                  </p>
                </div>
              </div>
