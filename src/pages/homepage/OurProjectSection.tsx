    ...
    const projects = [
        {
            ...
            title: "Scogo Admin",
            details: "Scogo Admin panel designing using Tailwindcss, react.js, redux and responsive admin panel.",
            technology: [

                // "HTML", "CSS", "CSS3", "react-bootstrap", "react.js", "node.js"
                "HTML", "CSS", "CSS3", "TailwindCSS", "Responsive", "react.js",
            ]
        },
        {
            type:"Admin - User",
            ...
            title: "Smartech",
            details: "Smartech Admin panel and User panel Website designing using HTML, CSS, Responsive, react.js, redux and implement using node.js.",
            technology: [
        ...
        },
        {
            ...
            title: "Spoweek",
            details: "Spoweek Admin panel and User panel Website designing using HTML, CSS, React Bootstrap, Responsive, react.js, redux and implement using node.js.",
            technology: [
        ...
        },
        {
            ...
            title: "Compastrips",
            details: "Compastrips Admin panel and User panel Website designing using HTML, CSS, React Bootstrap, Responsive, react.js, redux and implement using node.js.",
            technology: [
            ...
            <div className='OurProjectInnerctn'>
                <Container>
                    <Row className="align-items-center">
                        <Col xl={6} lg={8}>
                            <div className='ourProjectInnerTitle'>
                                ...
                                <p>Welcome To Karmadhi Solutions – Affordable Web Development Company.</p>
                    ...
                    <div className='mainSliderBox'>
                        <Slider {...settings}>
                            {projects.map((items) =>
                                <div className='mainSliderContentBox'>
