          ...
          <div className="NewTechInnerctn">
            <div className="NewTechTitleandContent">
              ...
              <p>
                ...
                or tool effectively, and are you looking for an experienced
                party that can help you in this? CodeImpact has qualified
                professionals who are in state-of-the-art technologies to give a
                powerful shape to your needs. &nbsp;
                {/* <span>Read more...</span> */}
              </p>
            ...
            <Slider {...settings}>
              <div className="sliderContent">
                <div className="position-relative">
                  ...
                  <img src="./img/sliderimg/slider-1.jpg" alt="SliderThree" />
