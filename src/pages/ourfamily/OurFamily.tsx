...
const OurFamily = () => {
  ...
  const getFamily = () => {
    ApiGet("employee?rpp=10&pg=0").then((res: any) => {
      setOurFamily(res.result);
    });
  };
  useEffect(() => {
    getFamily();
                ...
                <Col xl={6} lg={6} >
                  <div className='position-realtive'>
                    <div className='position-absolute mainImgTitle'>
                      <h1>If you don’t know where you are going. How can you expect to get there?</h1>
                    </div>
                ...
                <Col lg={6}>
                  <div className='detailsBox'>
                    <div className='closeBOX d-flex align-items-center'>
                      ...
                      <img src="./img/icone/blackClose.png" alt="" onClick={closeModal} />
                    </div>
                    <div className='title'>
                      ...
                      <Slider {...sertification}>
                        <div className=' w-100 certificationSliderInner'>
                          <div className='d-flex align-items-center justify-content-center'>
                            <img src="./img/icone/azure.png" alt="" className='certification' />
                    ...
                    <div className='emailbox d-flex align-items-center'>
                      <div className='d-flex align-items-center emailctn'>
                        <img src="./img/icone/email.png" alt="" className='email' />
                        <p>Karmadhi@gmail.com</p>
                      </div>
                      <img src="./img/icone/linkedin-logoColor.png" alt="" className='icon' />
                      <img src="./img/icone/instagramColor.png" alt="" className='icon' />
                      <img src="./img/icone/telegramColor.png" alt="" className='icon' />
                      <img src="./img/icone/skypeColor.png" alt="" className='icon' />
                    </div>
                    <div className='d-flex reviewMain justify-content-between'>
                      <div className='reviewResponsiveDiv'>
                        ...
                        <div className='d-flex align-items-center mainReviewbox justify-content-between'>
                          <p>OOP, Design <br /> Patterns, SOLID</p>
                          <div className='reviewStar d-flex align-items-center justify-content-between'>
                            <img src="img/icone/star1.png" alt="" />
                            <img src="img/icone/star1.png" alt="" />
                            <img src="img/icone/star.png" alt="" />
                      ...
                      <div className='reviewResponsiveDiv'>
                        ...
                        <div className='d-flex align-items-center mainReviewbox justify-content-between'>
                          <p> CSS, HTML, Bootstrap, <br /> jQuery, Ajax</p>
                          <div className='reviewStar d-flex align-items-center justify-content-between'>
                            <img src="img/icone/star1.png" alt="" />
                            <img src="img/icone/star1.png" alt="" />
                            <img src="img/icone/star.png" alt="" />
                    ...
                    <div className='descriptionbox'>
                      <p>
                        <b>Hi! My name is Alexandra.</b> <br />
                        I love programming and fighting with difficulties in any situations. Also, I like to communicate with people, investigate new tasks and creating the structure for the project. My hobbies are sports, cars, traveling and reading books.
                      </p>
                    </div>
                        ...
                        <Slider {...ProjectWork}>
                          <div className='projectSliderCtn'>
                            <div className='ProjectSliderImage'>
                              <img src="./img/images/projectsliderimg.png" alt="" />
                            </div>
