...
const Job = () => {
  ...
  const getJobs = () => {
    ApiGet("jobs?rpp=10&pg=0").then((res: any) => {
      setJobs(res.result);
    });
  };
  ...
  const JobsCard = [
    {
      ...
      content: "karmadhi Solutions  is currently looking for a Senior Node js Developers with min 1 year experience.",
      location: "Surat",
      Available: 2,
      contract: "Yes",
      english: "Yes",
    ...
    },
    {
      ...
      content: "karmadhi Solutions  is currently looking for a Senior React js Developers with min 1 year experience.",
      location: "Surat",
      Available: 1,
      contract: "Yes",
      english: "Yes",
    ...
    },
    {
      ...
      content: "karmadhi Solutions  is currently looking for a Senior Angular js Developers with min 1 year experience.",
      location: "Surat",
      Available: 1,
      contract: "Yes",
      english: "Yes",
    ...
    },
    {
      ...
      content: "karmadhi Solutions  is currently looking for a  PHP Laravel Developers with min 0 to 1 year experience.",
      location: "Surat",
      Available: 3,
      contract: "Yes",
      english: "Yes",
    ...
    },
    {
      ...
      content: "karmadhi Solutions  is currently looking for a  Mern Stack Developer with min 0 to 1 year experience.",
      location: "Surat",
      Available: 1,
      contract: "Yes",
      english: "Yes",
                          ...
                          <div className="jobcardbox">
                            ...
                            <div className="jobcardTitlebox">
                              <div className="urgentlyNeeded">
                                ...
                                <a href="mailto:info@karmadhisolutions.com">Contact Us</a>
                              </div>
                            ...
                            >
                              <div className="card card-body">
                                <ul>
                                  ...
                                  <li>Your experience match our requirements.</li>
                ...
                <div className="wrap-content-2">
                  ...
                  <div className="seccontactUsBox">
                    ...
                    <div className="contactUsInner">
                      ...
                      <a href="mailto:info@karmadhisolutions.com" className="text-decoration-none">
                        <div className="File">
